...
#ifndef CL_COLLECTABLE_H
#define CL_COLLECTABLE_H
...
{
public:
	CLCollectable(CLContext *context);
	virtual ~CLCollectable();

	CLContext *getContext() { return context; }

protected:
	friend class CLContext;
	friend class CLValue;
