...
{
	PHYSFS_file *file = (PHYSFS_file*)png_get_io_ptr(ctx);
...
DCDraw::Canvas LoadPNG(PHYSFS_file *file)
{
	...
	switch (color_type)
	{
		...
		case PNG_COLOR_TYPE_RGB: colorType = DCDraw::Canvas::RGB; break;
		case PNG_COLOR_TYPE_RGB_ALPHA: colorType = DCDraw::Canvas::RGBA; break;
	}
