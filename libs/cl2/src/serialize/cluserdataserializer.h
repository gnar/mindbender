...
#ifndef CL_USERDATASERIALIZER_H
#define CL_USERDATASERIALIZER_H
...
{
public:
	CLUserDataSerializer() {}
	virtual ~CLUserDataSerializer() {}

	virtual void save(CLSerialSaver &S, CLUserData *userdata) = 0;
	virtual CLUserData *load(CLSerialLoader &S) = 0;
};
